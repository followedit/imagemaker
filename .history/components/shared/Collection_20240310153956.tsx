...
export const Collection = ({
  ...
  return (
    ...
    {/* <section className="flex-center flex-col justify-center mt-20 mb-10 h-24">
    ...
    <div className="flex justify-center mb-24 mt-12 lg:mt-44 md:mt-40">
      {hasSearch && <Search />}
    </div>
      ...
      {totalPages > 1 && (
        <Pagination className="mt-10">
          <PaginationContent className="flex w-full">
            ...
            <Button
              className="button w-32 grad-color bg-cover text-white"
