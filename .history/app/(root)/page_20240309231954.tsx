...
const Home = async ({ searchParams }: SearchParamProps) => {
  ...
  return (
    <>
      <section className="flex-center flex-col justify-center top-nav bg-blue-950 h-1 mt-16">
        <ul className="flex-center w-full gap-20">
          {navLinks.slice(1, 5).map((link) => (
            ...
            >
              <li className="flex-center w-fit rounded-full bg-white p-4 hover:border-2 hover:border-blue-950 focus:ring focus:ring-blue-950">
