...
const Home = async ({ searchParams }: SearchParamProps) => {
  ...
  return (
    <>
      <section className="flex-center flex-col justify-center top-nav bg-blue-950 h-1 mt-0 bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
      ...
      <SignedOut>
      <section className="flex-center flex-col justify-center mt-20 lg:mt-36 md:mt-32 mb-10">
      ...
      <section className="centered">
          <Button asChild className="button grad-color bg-cover">
