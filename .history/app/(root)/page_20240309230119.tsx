      ...
      <section className="flex-center flex-col justify-center top-nav">
        <ul className="flex-center w-full gap-20">
          {navLinks.slice(1, 5).map((link) => (
            ...
            >
              <li className="flex-center w-fit rounded-full text-gray-950 bg-white p-4 hover:bg-blue-950 active:bg-blue-800 focus:outline-none focus:ring focus:ring-blue-500">
